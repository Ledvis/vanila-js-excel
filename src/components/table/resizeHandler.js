...
export const RESIZER_COLUMN = 'column';
export const RESIZER_ROW = 'row';
...
export default function($root, target) {
  return new Promise((resolve) => {
    ...
    const targetIndex = $parent.dataAttr().orderNumber;
    const resizerType = $resizer.dataAttr().resizer;
    ...
    document.onmouseup = () => {
      ...
      resolve({ value, id: targetIndex, resizer: resizerType });
